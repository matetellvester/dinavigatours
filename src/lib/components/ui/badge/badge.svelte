	...
	export const badgeVariants = tv({
		...
		variants: {
			variant: {
				...
				secondary: 'bg-border text-secondary-foreground hover:bg-secondary/80 border-transparent',
				destructive:
					'bg-destructive text-destructive-foreground hover:bg-destructive/80 border-transparent',
				outline: 'text-foreground',
				success: 'bg-green-600 text-primary-foreground hover:bg-green-600/80 border-transparent'
			}
		},
		defaultVariants: {
			variant: 'default'
