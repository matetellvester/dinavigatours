<script lang="ts">
	...
	function check(message: Message) {
		...
		// console.log(previousMessage.senderId);
		...
		// 	console.log('senderid: ', previousMessage.senderId, '\n');
		// 	console.log('receiverId: ', previousMessage.receiverId, '\n');
		// 	console.log('message senderid: ', message.senderId, ' - ', message.messageContent, '\n');
		// }
