<script lang="ts">
	import AppSidebar from '$lib/components/admin/sidebar/adm-app-sidebar.svelte';
	...
	import { admHeader } from './admin.svelte.js';
...
<Sidebar.Provider>
	...
	<Sidebar.Inset>
		...
		>
			...
			<h2 class="text-3xl font-bold tracking-tight">{admHeader.v}</h2>
...
{#snippet notifyCard(notif: Notif)}
	<a href="/adm/list" onclick={() => (open = false)} class="block pt-2">
